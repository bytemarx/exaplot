...
PyObject*
ModuleTest::Interface::plot(long dataSet, const std::vector<double>& data)
{
...
PyObject*
ModuleTest::Interface::plotVec(long dataSet, const std::vector<std::vector<double>>& data)
{
...
PyObject*
ModuleTest::Interface::clear(long dataSet)
{
